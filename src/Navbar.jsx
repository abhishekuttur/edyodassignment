...
import dropdown from './contents/Vector.png'
        ...
        <div>
            <nav className='row navbar'>
                <div className='col-6 d-flex '>
                    <span className='edyoda mt-1 col-4'>EDYODA</span>
                    <span className='mt-3'>Courses</span><img src={dropdown} className='dropdown mt-4'></img>
                    <span className='mt-3'>Programs</span><img src={dropdown} className='dropdown mt-4'></img>
                </div>
                <div className='col-6 mt-1 justify-content-center d-flex'>
                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg" className='mt-2'>
                    ...
                    <span className='login mx-5 mt-2'>Login</span>
